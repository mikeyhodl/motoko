 ...
 *
 * Autogenerated groups: as of Starlight 0.39 a group cannot carry `autogenerate`
 * alongside its `label`. The config goes inside `items`, and `collapsed` is
 * repeated there because autogenerated subgroups no longer inherit it from the
 * parent group:
 *
...
export const sidebar = [
  ...
  },
  {
    label: "ICP features",
    collapsed: true,
    items: [{ autogenerate: { directory: "icp-features", collapsed: true } }],
  },
  {
    label: "Reference",
    collapsed: true,
